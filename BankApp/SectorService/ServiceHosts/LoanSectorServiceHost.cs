...
{
	public class LoanSectorServiceHost : IDisposable
	{
		...
		public void OpenService()
		{
			...
			{
				Console.WriteLine($"LoanSectorServiceHost failed to open with an error: {ex.Message}");
			}
		}
		...
		public void CloseService()
		{
			...
			{
				Console.WriteLine($"LoanSectorServiceHost failed to close with an error: {ex.Message}");
			}
		}
